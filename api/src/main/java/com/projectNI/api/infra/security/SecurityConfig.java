    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/product/{id}").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/product/{id}/status").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/product/{id}").authenticated()
                        // --- Bidding Endpoints ---
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/bidding/{id}").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/bidding/{id}/status").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/bidding/{id}").authenticated()
                        // --- Supplier Endpoints ---
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/supplier/{id}").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/supplier/{id}/status").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/supplier/{id}").authenticated()
                        // --- Match Endpoints ---
