...
const BiddingProvider = ({ children }) => {
    ...
    const updateBidding = async (id, biddingData) => {
        try {
            ...
            const response = await api.post(`/bidding/update/${id}`, biddingData);
    ...
    const deleteBidding = async (id) => {
        try {
            ...
            await api.post(`/bidding/delete/${id}`);
    ...
    const updateBiddingStatus = async (id, status) => {
        try {
            ...
            const response = await api.post(`/bidding/update/status${id}`, { status });
